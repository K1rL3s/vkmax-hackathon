![img.png](backend/content/WaterMelon.png)
# MaxAlert 
...
- синхронизируется с мессенджером **MAX**,
- сохраняет все данные в надёжной связке **Postgres + Redis**.
...
- **t123_hakaton_bot** — интерфейс между пользователем и системой;
...
- 📅 **Отклик на событие**  
  ...
  - ❌ **Не буду**  
  - 🤷 **Не знаю**  
  - 🤐 **Не давать ответа** (по умолчанию — тишина)  

- 📢 **Все уведомления — только через бота:**  
  - ➕ Создание события  
  - 🗑️ Удаление события  
  - 🏷️ Назначение / снятие тега  
  - 👥 Назначение / удаление с события  
  - 📨 Общая рассылка  
