 ...
 * @summary Get Personal Group
 */
export const getPersonalGroupUsersMeGroupsPersonalGet = (
...
export type GetPersonalGroupUsersMeGroupsPersonalGetResult = NonNullable<Awaited<ReturnType<typeof getPersonalGroupUsersMeGroupsPersonalGet>>>
